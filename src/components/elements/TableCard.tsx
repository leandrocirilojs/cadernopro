...
export const TableCard: React.FC<TableCardProps> = ({
  ...
  return (
    <div 
      ...
      className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col relative transition-all hover:border-slate-300"
      style={{ 
        width: isDraggable ? `${element.width || Math.max(440, tableData.cols * 130 + 40)}px` : '100%',
    ...
    >
      ...
      {/* Table Container */}
      <div className="flex-1 overflow-auto border border-slate-200 rounded-lg min-h-[110px]">
      ...
      {isDraggable && (
        <ResizeHandle
          ...
          initialWidth={element.width || Math.max(440, tableData.cols * 130 + 40)}
